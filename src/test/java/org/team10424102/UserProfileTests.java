...
import org.team10424102.config.security.TokenAuthenticationFilter;
...
public class UserProfileTests extends BaseTests{
    ...
    public void register_withValidPhoneAndVcode() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(App.API_TOKEN).param("phone", UNREGISTERED_PHONE).param("vcode", "1234"))
    ...
    public void unregister() throws Exception {
        MvcResult result = mockMvc
                .perform(MockMvcRequestBuilders.get(App.API_TOKEN).param("phone", UNREGISTERED_PHONE).param("vcode", "1234"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void updateProfile_username() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(App.API_USER).header(TokenAuthenticationFilter.TOKEN_HEADER, token))
                .andExpect(status().isOk())
    ...
    public void getProfile() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get(App.API_USER).header(TokenAuthenticationFilter.TOKEN_HEADER, token))
