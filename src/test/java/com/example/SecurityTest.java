...
import com.example.config.security.ExternalServiceAuthenticator;
import com.example.config.security.test.AuthenticatedExternalWebService;
import com.example.config.security.test.ServiceGateway;
...
@SpringApplicationConfiguration(classes = {App.class, SecurityTest.SecurityTestConfig.class})
@WebAppConfiguration
