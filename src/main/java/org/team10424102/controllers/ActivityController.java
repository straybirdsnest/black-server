...
import org.team10424102.models.Activity;
import org.team10424102.services.ActivityService;
...
public class ActivityController {
     ...
     */
    @RequestMapping(value = API_ACTIVITY, method = GET)
     ...
     * 获取活动的详细信息
     */
    @RequestMapping(value = API_ACTIVITY + "/{id}", method = GET)
     ...
     * @return
     */
    @RequestMapping(value = API_ACTIVITY, method = POST)
    public void createActivity(Activity activity) {
        activityService.createActivity(activity);
    }

    @RequestMapping(value = API_ACTIVITY + "/{id}", method = DELETE)
    @JsonView(Views.ActivityDetails.class)
