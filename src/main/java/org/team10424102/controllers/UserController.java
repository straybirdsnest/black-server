...
import org.team10424102.Api;
import org.team10424102.config.json.Views;
import org.team10424102.daos.FriendshipRepo;
import org.team10424102.exceptions.VcodeVerificationException;
import org.team10424102.models.Friendship;
import org.team10424102.models.User;
import org.team10424102.services.UserService;
import org.team10424102.services.VcodeService;
...
import static org.team10424102.App.*;
...
//    }
     ...
     * 获取当前用户的关注列表
     */
    @RequestMapping(value = API_USER + "/focuses", method = GET)
     ...
     * 获取当前用户的粉丝列表
     */
    @RequestMapping(value = API_USER + "/fans", method = GET)
    @JsonView(Views.UserSummary.class)
     ...
     * 关注一个用户
     */
    @RequestMapping(value = API_USER + "/focuses/{id}", method = POST)
     ...
     * 取消关注一个用户
     */
    @RequestMapping(value = API_USER + "/focuses/{id}", method = DELETE)
     ...
     * 获取当前用户的朋友
     */
    @RequestMapping(value = API_USER + "/friends", method = GET)
    @JsonView(Views.UserSummary.class)
     ...
     * 添加一个朋友
     */
    @RequestMapping(value = API_USER + "/friends/{id}", method = POST)
     ...
     * 删除一个朋友
     */
    @RequestMapping(value = API_USER + "/friends/{id}", method = DELETE)
     ...
     * 修改一个朋友的备注名称
     */
    @RequestMapping(value = API_USER + "/friends/{id}", method = PUT)
