 ...
 */
public class ErrorLogPrintWriter extends PrintWriter {
     ...
     */
    public ErrorLogPrintWriter(Writer out) {
        super(out);
    }
     ...
     */
    public ErrorLogPrintWriter(Logger log) {
